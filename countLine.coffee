...
createTask = (file) ->
	...
	->
		...
		new Promise (resolve, reject) ->
			...
			# transform2 = (chunk, enc, cb) ->

			# 	if ref2 is null
			# 		ref2 = chunk
			# 	else
			# 		ref2 = turf.union ref2, chunk

			# 	console.log "on transform2 counter:", counter
			...
			.on 'data', (chunk) ->
				for chunky in chunk
					if chunky == 10 or chunky == 13
						lineCount++
				return undefined

			.on 'end', ->
				console.log "read file:", lineCount
